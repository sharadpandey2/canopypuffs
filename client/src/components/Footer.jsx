...
// --- Social Link Component (Luxury Style) ---
const SocialLink = ({ icon: Icon, href }) => (
  <motion.a
    href={href}
    target="_blank"
    rel="noopener noreferrer"
    whileHover={{ y: -3, backgroundColor: "rgba(255, 255, 255, 1)", color: "#000" }}
...
// [!] Accept onPrivacyClick prop here
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-24">
          ...
          <div className="space-y-8 max-w-md">
            ...
            <p className="text-sm text-gray-400 font-light leading-relaxed tracking-wide">
              Redefining aerial dominance through autonomous systems. <br />
            ...
            <div className="flex gap-4">
              <SocialLink 
                icon={Instagram} 
                href="https://www.instagram.com/canopy_puffs?igsh=MXA2eXpqaXJlcXNwMg==" 
              />
              <SocialLink 
                icon={Linkedin} 
          ...
          {/* Legal Link (Right Side) - Converted to Button */}
